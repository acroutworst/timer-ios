...
namespace TestTimer
{
	public partial class ViewController : UIViewController
	{
		...
		private void SetupUserInterface()
		{
			...
			toggleStopButton.SetTitleColor(UIColor.Black, UIControlState.Normal);
			...
			togglePauseButton.SetTitleColor(UIColor.Black, UIControlState.Normal);
			...
			toggleResumeButton.SetTitleColor(UIColor.Black, UIControlState.Normal);
